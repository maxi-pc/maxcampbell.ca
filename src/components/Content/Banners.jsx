...
const Banners = () => {
    ...
    return (
        ...
        <Slide className='card-container'><div className='card-container'>
        
      <div className='card-row'>
          <Slide><a href='/about'><div className='card' tabIndex='0'>
 ...
 <Slide><a href='/portfolio'><div className='card' tabIndex='1'>
        ...
        <Slide><a href='/contact'><div className='card' tabIndex='2'>
